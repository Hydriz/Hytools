...
<p>Welcome to the edit count search tool, the place where you can query the number of edits a user has made on a project! Just input the required fields below and the tool will do the rest!</p>
<form action="editcount_result.php" method="get">
Name of user: <input type="text" name="username" /><br />
Project: <input type="text" name="lang" size="8" />.<input type="text" name="project" />.org<br />
<input type="submit" />
</form>
</p>
