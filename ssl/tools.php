...
<head> 
<title>Tools - Hydriz on Toolserver</title> 
...
<h1 id="firstHeading" class="firstHeading">Tools</h1> 
<div id="bodyContent"> 
...
<p>Here are some tools which can be of use to you:</p>
<ul>
	<li><a href="/~hydriz/tools/editcount.php" title="An edit count tool that displays the edit count of a specific user in a specific project">Edit count</a></li>
</ul>
</p>
...
<div id="p-views" class="vectorTabs"> 
	...
	<ul> 
		...
		<li id="ca-edit"><span><a href="https://github.com/AlphaCorp/Hytools/tree/<?php require_once('LocalSettings.php'); echo $hyVersion; ?>/ssl/tools.php"  title="Preview the source code for this page" accesskey="e">View source</a></span></li> 
