...
<div id="p-views" class="vectorTabs"> 
	...
	<ul> 
		...
		<li id="ca-edit"><span><a href="https://github.com/AlphaCorp/Hytools/tree/<?php require_once('LocalSettings.php'); echo $hyVersion; ?>/ssl/matrix.php"  title="Preview the source code for this page" accesskey="e">View source</a></span></li> 
